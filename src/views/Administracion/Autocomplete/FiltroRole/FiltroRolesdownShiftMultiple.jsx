...
const suggestions = [
  ...
  class FiltroRolesdownShiftMultiple extends React.Component {
    state = {
      inputValue: '',
      selectedItem: [],
    };
